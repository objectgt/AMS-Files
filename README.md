...
This is a mod that automatically reports users on https://www.objectgt.org/api/serverdata/otherserverdata. This is made to be added into other mods, and to do that, all you need to do is:
